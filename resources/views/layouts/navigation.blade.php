<nav x-data="{ open: false }" class="bg-violet-300 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('catigory.index')" :active="request()->routeIs('catigory.index')">
                        {{ __('Add Catigory ➕ ') }}
                    </x-nav-link>
                </div>
            ...
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('product.show')" :active="request()->routeIs('dashboard')">
                        {{ __('Home🏠') }}
                    </x-nav-link>
                </div>
            </div>
